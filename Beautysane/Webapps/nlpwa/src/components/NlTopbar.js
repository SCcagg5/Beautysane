...
class NlTopbar extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <nav className="navbar navbar-expand-lg navbar-dark px-5" style={{backgroundColor:"#05ba4d"}}>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            ...
                            <li className={this.props.page==="mag"? "nav-item active" :"nav-item "}>
                                <a className="nav-link" href="#">MAG</a>
                            </li>
                            <li className={this.props.page==="bodycheck"? "nav-item active" :"nav-item "}>
                                <a className="nav-link" href="#">BODYCHECK</a>
                            </li>
                            <li className={this.props.page==="mybs"? "nav-item active" :"nav-item "}>
                                <a className="nav-link" href="#">MyBS</a>
                            </li>
                            <li  className={this.props.page==="recette"? "nav-item active" :"nav-item "}>
                                <a className="nav-link" href="/listrecette">RECETTE</a>
                            </li>
