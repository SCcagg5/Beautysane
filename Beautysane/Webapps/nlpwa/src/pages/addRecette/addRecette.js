...
async getPreparation(){
        ...
        if (e.target.textContent.length!=0){
            ...
            this.state.foodlist[name1].map((item,key2)=>{
                if (item.value===event.value && item.text===e.target.textContent){
                    ...
                    if (item.woo_prod!=null&& item.woo_prod!=""){
                        data[name1][key]["woo_prod"] = item.woo_prod
                    }
    ...
    handleChange2(event,name1,name2,key){
        ...
        if (name2==="nom_Ingr"){
            const { myValue  , myImage ,myWoo} = event.currentTarget.dataset;
        ...
        return (
            <div >
                ...
                <div className="wrapper">
                    <div className="container-fluid p-5 justify-content-around border border-success">
                                            ...
                                            <div className="col-md-1">
                                                ...
                                                >
                                                    { legumes.filter(name => (name.text.startsWith('A')||name.text.startsWith('B'))).map(filteredName => (
                                                        <MenuItem value={filteredName.value}  data-my-value={filteredName.text} data-my-image={filteredName.image_url} data-my-woo={filteredName.woo_prod} >{filteredName.text} </MenuItem>
                                                    ))}
