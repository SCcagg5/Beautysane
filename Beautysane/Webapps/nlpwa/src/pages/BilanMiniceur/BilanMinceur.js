...
import  "./styleminiceur.css"
import Snackbar from "@material-ui/core/Snackbar";
import MySnackbarContentWrapper from "../../tools/customSnackBar";
const url = process.env.REACT_APP_endpoint;

class BilanMinceur extends Component {
    constructor(props){
        super(props)
        this.state={
             questions:data,
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <h1 style={{fontWeight:"normal",fontSize:35,fontFamily:"goudar_hlextralight ,sans-serif",textTransform:"uppercase",lineHeight:1,color:"#dec849"}}>
                                    ...
                                    <div className="mt-3">
                                        <text style={{textTransform:"uppercase",color:"#dec849"}}>
                    ...
                    <div className="p-4 mt-3 mb-5" style={{backgroundColor:"white"}}>
                        ...
                        <div className="containerSM " >
                            ...
                            <div className="progress ml-auto mr-auto w-75 " >
                                <div className="progress-bar" role="progressbar" style={{width: pb + "%", backgroundColor: "#fffad8"}}
                                    ...
                                    <div style={{marginTop: "10%"}}>
                                        ...
                                        this.state.questions[number].responses.map((item, key) => (
                                            <button onClick={() => this.selected(number, key)}
                                                    className={item.selected === "true" ? "btn btn-minceur  mt-1 activee" : "btn btn-minceur  inactive mt-1"}
                                        ...
                                        this.state.questions[number].responses.map((item, key) => (
                                            <div>
                                                ...
                                                <input placeholder={item.placeholder} value={localStorage.getItem('email')}
                                                       ...
                                                       value={this.state.questions[35].rep || ""}
                                                       className="form-control mt-2"
                                                />
                                                <div className="text-center">
                                                <button onClick={() => this.sendMail()}
                                                        className="btn btn-minceur mt-2"
                            ...
                            <div className="row  justify-content-center mt-4 w-75">
                                ...
                                <div className="col-6">
                                    <button onClick={() => this.setState({questionN: this.state.questions[number].next})} type="button" className="btn btn-minceur " style={{width: "100%",backgroundColor:"#fffad8",color:"black"}}> PAGE SUIVANTE</button>
