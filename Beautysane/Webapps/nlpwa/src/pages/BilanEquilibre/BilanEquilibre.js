...
class BilanEquilibre extends Component {
    constructor(props){
        super(props)
        this.state={
            questions:data,
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div style={{maxWidth:"60%"}}>
                                    <h1 style={{fontWeight:"normal",fontSize:35,fontFamily:"goudar_hlextralight ,sans-serif",textTransform:"uppercase",lineHeight:1,color:"#db72c2"}}>
                                        MANGER SAIN ET SANS PRISE DE TETE                                    </h1>
                                    <text>
                                        Tous les apports nutritionnels dont votre corps a besoin en un seul repas, prêt en 2 minutes, au bureau, au grand air comme à la maison !
                                    </text>
                                    <div className="mt-3">
                                        <text style={{textTransform:"uppercase",color:"#db72c2"}}>
                                            RECEVEZ VOTRE LIVRET RECETTES GRATUIT
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <TextField id="standard-basic" onChange={(e)=>{this.changeText(31,0,e)}} value={this.state.questions[31].rep || ""} label="Mon age (en années)" />
                                ...
                                <div className="row mt-2">
                                    <div className="col-md-6">
                                        <TextField onChange={(e)=>{this.changeText(33,0,e)}} value={this.state.questions[33].rep || ""} style={{fontWeight:"normal",fontFamily:"sans-serif"}} id="standard-basic" label="Poids (en kilos)" />
                    ...
                    <div className="p-4 mt-3 mb-5" style={{backgroundColor:"white"}}>
                        ...
                        <div className="containerSM " >
                            ...
                            <div className="progress ml-auto mr-auto w-75 " >
                                <div className="progress-bar" role="progressbar" style={{width: pb + "%", backgroundColor: "#db72c2"}}
                                    ...
                                    <div style={{marginTop: "10%"}}>
                                        ...
                                        this.state.questions[number].responses.map((item, key) => (
                                            <button onClick={() => this.selected(number, key)}
                                                    className={item.selected === "true" ? "btn btn-equilibre mt-1 activee" : "btn  btn-equilibre inactive mt-1"}
                                                    style={{width: "80%", marginTop: "10%" ,color:"black"}}>{item.text}</button>
                                        ))}
                                        ...
                                        this.state.questions[number].responses.map((item, key) => (
                                            <div>
                                                ...
                                                <button onClick={() => this.sendMail()}
                                                        className="btn btn-equilibre mt-2 "
                                                        style={{width: "80%"}}>Recevoir L'evaluation par email</button>
                                                </div>
                                            </div>
                            ...
                            <div className="row  justify-content-center mt-4 w-75">
                                <div className="col-3">
                                    <button onClick={() => this.setState({questionN: this.state.questions[number].prec})} type="button" className="btn btn-equilibre  font-weight-bold" style={{width: "100%"}} > {this.state.back}</button>

                                </div>
                                <div className="col-6">
                                    <button onClick={() => this.setState({questionN: this.state.questions[number].next})} type="button" className="btn  " style={{width: "100%",backgroundColor:"#db72c2"}}> PAGE SUIVANTE</button>
