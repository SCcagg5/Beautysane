...
import BilanMinceur from "./pages/BilanMiniceur/BilanMinceur";
import BilanSport from "./pages/BilanSport/BilanSport";
import BilanEquilibre from "./pages/BilanEquilibre/BilanEquilibre";
  ...
  componentWillMount() {
    ...
    return(
        <Router>
            ...
            <Route exact path="/listrecette" component={listeRecette}/>
            ...
            <Route exact path="/BilanMinceur" component={BilanMinceur}/>
            <Route exact path="/BilanSport" component={BilanSport}/>
            <Route exact path="/BilanEquilibre" component={BilanEquilibre}/>
