            ...
            <div className="mb-5">
                ...
                <div className="wrapper">
                    <div className="container ">
                        <ul className="ul">
                            <li style={{borderBottomColor:this.state.selectedItem==="vue"?"#2eba5f":"white",borderBottomWidth:1.5,borderBottomStyle:"solid"}} onClick={()=>{this.props.history.replace("/dashboard/vue")
                            ...
                            <li className="row align-items-center" style={{borderBottomColor:this.state.selectedItem==="BS"?"#2eba5f":"white",borderBottomWidth:1.5,borderBottomStyle:"solid"}} onClick={()=>{this.props.history.replace("/dashboard/BS")
                            ...
                            <li onClick={()=>this.props.history.push("/login")} className="row align-items-center">
                            ...
                            <div className="mt-5">
                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="mt-2">
                                            <text>jawher.zairi@sesame.com.tn</text>
                                        </div>
                            ...
                            <Tabs className="text-center">
                                ...
                                <TabPanel>
                                    ...
                                    <div className="text-left mt-5">
                                        <div className="row justify-content-start">
                                            <div className="col-md-6">
                                                <h4 className="font-weight-bold">Zairi jawher</h4>
                                ...
                                <TabPanel>
                                    <table className="table table-bordered text-center">
                                        ...
                                        <tr>
                                            <th scope="col"> <text style={{color:"white"}}>Libellé analyse </text></th>
                                            <th scope="col"><text style={{color:"white"}}>Résultat </text></th>
                                            <th scope="col"><text style={{color:"white"}}>Unité</text></th>
                                            <th scope="col"><text style={{color:"white"}}>Référence</text></th>
                                            <th scope="col"><text style={{color:"white"}}>Graphiques</text></th>
                                            <th scope="col" width={"10%"}><text style={{color:"white"}}>Historique</text></th>
                                        </tr>
                                        </thead>
